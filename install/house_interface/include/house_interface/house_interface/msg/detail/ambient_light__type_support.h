...
#ifndef HOUSE_INTERFACE__MSG__DETAIL__AMBIENT_LIGHT__TYPE_SUPPORT_H_
#define HOUSE_INTERFACE__MSG__DETAIL__AMBIENT_LIGHT__TYPE_SUPPORT_H_
...
#endif  // HOUSE_INTERFACE__MSG__DETAIL__AMBIENT_LIGHT__TYPE_SUPPORT_H_
